...
public class SecondObjectClass extends building{
	...
	public void interfaceOneMethod(){//calls its parent class but also states what object the method is called by
		...
		System.out.println("from Object Class two");
		System.out.println("-------------------------------");
		}
		if(super.isPass()==false) {
			System.out.println("second object class will not print the abstract method from the first interface class.");
		}
	}
	public void interfaceTwoMethod(){//calls its parent class but also states what object the method is called by
		...
		if(super.isPass2()==false) {
			System.out.println("second object class will not print the abstract method from the second interface class.");
		}
	}
	public void interfaceThreeMethod(){//calls its parent class but also states what object the method is called by
		...
		if(super.isPass3()==false) {
			System.out.println("second object class will not print the abstract method from the third interface class.");
		}
	}
}