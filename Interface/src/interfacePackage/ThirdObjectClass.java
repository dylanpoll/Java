...
public class ThirdObjectClass extends building{
	...
	public void interfaceOneMethod(){//calls its parent class but also states what object the method is called by
		...
		System.out.println("from Object Class three");
		System.out.println("-------------------------------");
		}
		if(super.isPass()==false){
			System.out.println("third object class will not print the abstract method from the third interface class.");
		}
	}
